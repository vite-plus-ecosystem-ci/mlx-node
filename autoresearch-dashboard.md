...
**Runs:** 11 | **Kept:** 10 | **Discarded:** 1 | **Crashed:** 0
**Baseline:** decode_tok_s: 2.4 tok/s (#1)
**Best:** decode_tok_s: 7.4 tok/s (#11, +208.3%)
...
| 4 | f4c1d42 | 2.8 tok/s (+16.7%) | 162/163 | yes | yes | 2739ms | keep | batch size 64→512, dedup (C++ not in WASM) |
| 5 | 9770666 | 4.1 tok/s (+70.8%) | 162/163 | yes | yes | 1585ms | keep | fuse dispatch into single RPC |
| 6 | 9770666 | 3.6 tok/s | 162/163 | yes | yes | 2300ms | discard | buffer size cache (Map+BigInt, slow) |
...
| 10 | e47239a | 7.2 tok/s (+200.0%) | 162/163 | yes | yes | 824ms | keep | cache buffer sizes (plain object) |
| 11 | 15f1c64 | **7.4 tok/s (+208.3%)** | 162/163 | yes | yes | **826ms** | keep | optimize rpcCall hot path |
