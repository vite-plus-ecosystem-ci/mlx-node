...
const CASES: Case[] = [
  ...
  },
  {
    ...
    tokens: ["你", "好"],
    takeaway:
      "CJK characters usually land as one token each — large vocab coverage, no leading-space marker needed.",
  },
  {
    label: "Devanagari",
    input: "नमस्ते",
    tokens: ["न", "म", "स", "्", "त", "े"],
    takeaway:
      "Rarer scripts decompose into byte-level fragments. The chars/token ratio drops well below 1.",
  },
  {
        ...
        {CASES.map((c, ci) => (
          ...
          >
            <div>
              ...
              <dd className="mt-1 break-all font-mono text-[12px] text-foreground/90">
